...
def spending_by_weekday_valid() -> pd.DataFrame:
    return pd.DataFrame([{'Дата операции': '10.01.2026 13:01:22', 'Статус': 'OK',
                          'Сумма операции': -27068.0}, {
                             'Дата операции': '10.01.2026 13:00:04', 'Дата платежа': '10.01.2018', 'Статус': 'OK',
                             'Сумма операции': -30000.0, }, {
                             'Дата операции': '10.01.2026 12:59:23', 'Дата платежа': '10.01.2018', 'Статус': 'OK',
                             'Сумма операции': 36000.0, }, {
                             'Дата операции': '09.01.2026 12:43:34', 'Дата платежа': '10.01.2018',
                             'Статус': 'OK', 'Сумма операции': -30068.0, }, {
                             'Дата операции': '09.01.2026 12:42:44', 'Дата платежа': '10.01.2018',
                             'Статус': 'FAILED', 'Сумма операции': -40068.0, }, {
                             'Дата операции': '09.01.2026 12:41:24', 'Дата платежа': '10.01.2018',
                             'Статус': 'FAILED', 'Сумма операции': -87068.0, }, {
                             'Дата операции': '08.01.2026 21:29:43', 'Дата платежа': '10.01.2018', 'Статус': 'OK',
                             'Сумма операции': -364.49, }, {
                             'Дата операции': '07.01.2026 14:21:23', 'Дата платежа': '10.01.2018', 'Статус': 'OK',
                             'Сумма операции': 250.0, }, {
                             'Дата операции': '07.01.2026 13:38:08', 'Дата платежа': '10.01.2018', 'Статус': 'OK',
                             'Сумма операции': -1004.9, }, {
                             'Дата операции': '07.01.2026 15:28:22', 'Дата платежа': '07.01.2018', 'Статус': 'OK',
                             'Сумма операции': -79.6, }])


@pytest.fixture()
def spending_by_weekday_valid_result() -> dict:
    return {'Средние траты в каждый из дней недели за последние три месяца': {'Wednesday': 542.25,
                                                                              'Thursday': 364.49, 'Friday': 30068.00,
                                                                              'Saturday': 28534.00}}
